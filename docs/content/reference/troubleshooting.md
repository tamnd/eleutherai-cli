...
Most of these come down to network reality or how eleutherai serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

eleutherai rate-limits like any public site. eai already paces
...
Where a surface is gated, eai reads a cookie or token you supply
...
`eai`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what eai actually did
